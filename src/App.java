...
public class App {
    public static void main(String[] args) throws Exception {
       ...
       /*System.out.println("Insira o item 1");
        ...
        //System.out.println("Seus items são: "+ minhaLista[0] +" - " + minhaLista[1]+" - "+ minhaLista[2]+" - "+ minhaLista[3]+" - "+ minhaLista[4]);
        System.out.println("Os Itens da sua lista são: ");
        for (int i = 0; i < minhaLista.length; i++) {
            System.out.println((i+1) + " - " + minhaLista[i]);
        }
    }
}
